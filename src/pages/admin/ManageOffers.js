...
import BudgetAnalytics from '../../components/admin/BudgetAnalytics';
...
const ManageOffers = () => {
    ...
    <DashboardLayout>
      ...
      >
        <div className="mb-6">
          ...
          <p className="text-gray-600">Configure seasonal offers and analyze pricing performance</p>
        </div>
 ...
 <div className="mb-8">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Budget Analytics</h2>
          <BudgetAnalytics />
        </div>
